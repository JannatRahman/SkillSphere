...
const Banner = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="bg-white rounded-lg mt-5 flex flex-col-reverse lg:flex-row items-center justify-between shadow-md animate__animated animate__pulse overflow-hidden">
